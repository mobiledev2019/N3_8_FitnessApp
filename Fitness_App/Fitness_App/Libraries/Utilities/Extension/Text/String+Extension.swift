...
extension String {
    ...
    func isEmail() -> Bool {
        if self.getBytesBy(encoding: SystemInfo.shiftJISEncoding) != self.count { return false }
    ...
    func set(lineSpacing: CGFloat, paragraphSpacing: CGFloat) -> NSAttributedString {
        let paragraphStyle = NSMutableParagraphStyle()
        paragraphStyle.lineSpacing = lineSpacing
        paragraphStyle.paragraphSpacing = paragraphSpacing
        let attrText = NSMutableAttributedString(string: self, attributes: [
...
extension String {
    func japanDateString(fromTimeZone: TimeZone = Date.currentTimeZone,
                          toTimeZone: TimeZone = Date.jstTimeZone,
                          format: String,
                          calendar: Calendar = Date.currentCalendar) -> String? {
        let dateFormatter = DateFormatter()
        dateFormatter.dateFormat = format
        dateFormatter.calendar = calendar
    ...
    func localeDateString(fromTimeZone: TimeZone = Date.jstTimeZone,
                          toTimeZone: TimeZone = Date.currentTimeZone,
                          format: String,
                          calendar: Calendar = Date.currentCalendar) -> String? {
        let dateFormatter = DateFormatter()
        dateFormatter.dateFormat = format
