...
class DateTimePicker: BasePicker {
    ...
    @discardableResult
    func set(day: Int, month: Int, year: Int, minDate: Date? = nil, maxDate: Date? = nil, locale: Locale?) -> DateTimePicker {
    ...
    @discardableResult
    func set(date: Date, minDate: Date? = nil, maxDate: Date? = nil, locale: Locale?) -> DateTimePicker {
    ...
    @discardableResult
    func set(hour: Int, minute: Int, minTime: Date? = nil, maxTime: Date? = nil, locale: Locale?) -> DateTimePicker {
