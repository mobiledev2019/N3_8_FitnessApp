...
extension UIColor {
    ...
    struct Custom {
        static let AppFirst = UIColor.init(hexValue: 0x634827)
        static let AppSecond = UIColor.init(hexValue: 0x070B38)
        static let AppMainDark = UIColor.init(hexValue: 0xF6BC44)
        static let AppPhu = UIColor.init(hexValue: 0xC3C3C3)
